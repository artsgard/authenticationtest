...
@EnableJpaRepositories(basePackages = {"com.artsgard.athenticationtest.repository", "com.artsgard.athenticationtest.config" },
...
public class BatchDbRepoConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		return builder
                    ...
                    .packages("com.artsgard.athenticationtest.model")
                    .persistenceUnit("db")
                    .build();
	}
